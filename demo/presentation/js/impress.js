...
//         logLevel: 'DEBUG',
    ...
    var impressHI = window.impressHI = new HumanInput(document.body, HIsettings); // Let's enhance impress.js!
    ...
    var impress = window.impress = function( rootId ) {
        ...
        var goto = function( el, duration ) {
            ...
            if ( !initialized || !( el = getStep( el ) ) ) {
                console.log('Presentation not initialized or given element is not a step', el, getStep( el ));
        ...
        var prev = function() {
            ...
            impressHI.trigger('impress:prev');
        ...
        var next = function() {
            ...
            impressHI.trigger('impress:next');
...
( function( document, window ) {
    ...
    document.addEventListener( "impress:init", function( event ) {
        ...
        // Original Impress.js code for preventing default on keydown events.  Hope you remember what those keycodes mean!
...
//         }, false );
        ...
        impressHI.on(['tab', 'pageup', 'right', 'up', 'space', 'swipe:right', 'wheel:down', 'wheel:right'], function(e, key) {
            api.next(); // Move to the next slide
            if (e.target.tagName != 'TEXTAREA' || document.activeElement != 'TEXTAREA') {
                return false; // Make sure they don't do what they normally do.
            }
        });
        impressHI.on(['pagedown', 'left', 'down', 'swipe:left', 'wheel:left', 'wheel:up'], function(e, key) {
            api.prev(); // Move to the previous slide
            if (e.target.tagName != 'TEXTAREA' || document.activeElement != 'TEXTAREA') {
                return false; // Make sure they don't do what they normally do.
            }
        });
        // This is what Impress.js was using originally...  What a mess!  And it doesn't work with non-US keyboard layouts!
...
//         }, false );
        ...
        // A massive improvement over the original Impress.js way:
        impressHI.on('click', function(e) {
            var target = e.target;
            ...
            if (!target.classList.contains("active")) {
                if (api.goto(target)) {
                    return false; // This automatically calls preventDefault()
                }
            }
        });
