(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['module', 'exports', './polyfills', './utils', './logger', './events', './keymaps'], factory);
    } else if (typeof exports !== "undefined") {
        factory(module, exports, require('./polyfills'), require('./utils'), require('./logger'), require('./events'), require('./keymaps'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod, mod.exports, global.polyfills, global.utils, global.logger, global.events, global.keymaps);
        global.humaninput = mod.exports;
    }
})(this, function (module, exports, _polyfills, _utils, _logger, _events, _keymaps) {
    'use strict';
    ...
    var HumanInput = function (_EventHandler) {
        ...
        HumanInput.prototype.init = function init() {
            ...
            for (var _i = 0; _i < plugins.length; _i++) {
                ...
                if (!(plugin_instances[_i] instanceof plugins[_i])) {
                    plugin_instances[_i] = new plugins[_i](this);
                }
                var plugin = plugin_instances[_i];
        ...
        HumanInput.prototype._handleShifted = function _handleShifted(down) {
            ...
            */
            ...
            for (var _i2 = 0; _i2 < down.length; _i2++) {
                shiftKeyIndex = down[_i2].indexOf('Shift');
                if (shiftKeyIndex != -1) {
                    break;
                }
            }
        ...
        HumanInput.prototype._handleDownEvents = function _handleDownEvents() {
            ...
            for (var _i3 = 0; _i3 < events.length; _i3++) {
                results = results.concat(this._triggerWithSelectors(events[_i3], args));
            }
            if (settings.listenEvents.includes('hold')) {
            ...
            if (lastDownLength < down.length) {
                ...
                if (this.sequenceFilter(e)) {
                    ...
                    if (seqBuffer.length > 1) {
                        ...
                        for (var _i4 = 0; _i4 < combos.length; _i4++) {
                            var sliced = (0, _utils.seqSlicer)(combos[_i4]);
        ...
        HumanInput.prototype._holdCounter = function _holdCounter() {
            ...
            for (var _i5 = 0; _i5 < events.length; _i5++) {
                ...
                this.trigger('hold', events[_i5], realHeldTime);
                // This is the meat of hold events:
                this._triggerWithSelectors('hold:' + state.heldTime + ':' + events[_i5], lastArg.concat([realHeldTime]));
            }
            state.heldTime += settings.holdInterval;
        ...
        HumanInput.prototype.stopRecording = function stopRecording(filter) {
            ...
            */
            ...
            if (filter == 'keystroke') {
                ...
                for (var _i6 = 0; _i6 < filteredEvents.length; _i6++) {
                    if (regex.test(filteredEvents[_i6])) {
                        break;
                    }
                    keystroke = filteredEvents[_i6];
                }
                return keystroke;
            }
            // Apply the filter
        ...
        HumanInput.prototype.isDown = function isDown(name) {
            ...
            */
            ...
            for (var _i7 = 0; _i7 < state.down.length; _i7++) {
                var down = state.down[_i7].toLowerCase();
                var downAlt = state.downAlt[_i7].toLowerCase(); // In case something changed between down and up events
                if (name == down || name == downAlt) {
                    return true;
                } else if (SHIFTKEYS.includes(state.down[_i7])) {
                    if (name == ShiftKeyEvent) {
                        return true;
                    }
                } else if (CONTROLKEYS.includes(state.down[_i7])) {
                    if (name == ControlKeyEvent) {
                        return true;
                    }
                } else if (ALTKEYS.includes(state.down[_i7])) {
                    if (name == AltKeyEvent) {
                        return true;
                    }
                } else if (OSKEYS.includes(state.down[_i7])) {
                    if (name == OSKeyEvent) {
                        return true;
                    }
                }
        ...
        HumanInput.prototype.getDown = function getDown() {
            ...
            */
            ...
            var out = '';
            for (var _i8 = 0; _i8 < down.length; _i8++) {
                out += this._keyEvent(down[_i8]) + '-';
            }
