(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './humaninput', './utils', './constants'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./humaninput'), require('./utils'), require('./constants'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.humaninput, global.utils, global.constants);
        global.feedback = mod.exports;
    }
})(this, function (exports, _humaninput, _utils, _constants) {
    'use strict';
